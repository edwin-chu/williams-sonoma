...
public class DataHelper
{
	 ...
	 * @throws DataTypesTypeException
	 */
	public static Object[][] evalDatabaseTable(String driverClassString, String databaseStringUrl, String username, String password, String tableName, int rowOffset, int colOffset,
			DataType[] dataTypes) throws DataTypesMismatchException, ClassNotFoundException, SQLException, DataTypesCountException, DataTypesTypeException
	{
	 ...
	 */
	public static Object[][] getExcelFileData(String fileLocation, String fileName, Boolean hasLabels, DataType[] dataTypes) throws InvalidExcelExtensionException
	{
	 ...
	 * @return
	 */
	public static Object[][] getTextFileData(String fileLocation, String fileName, TextFormat textFormat, Boolean hasLabels, DataType[] dataTypes)
	{
		Object[][] data;
			...
			while (rowIterator.hasNext())
			{
				...
				while (cellIterator.hasNext())
				{
					...
					case Cell.CELL_TYPE_NUMERIC:
						...
						{
							System.out.print((float) cell.getNumericCellValue() + "(" + dataTypes[curColumn] + ")\t\t\t");
	 ...
	 */
	private static Object convertDataType(String parameter, DataType dataType) throws BooleanFormatException, CharacterCountFormatException
	{
		Object data = null;
		try
		{
	 ...
	 * @throws IOException
	 */
	private static ArrayList<Object> getNewExcelFileResults(String fileLocation, String fileName, Boolean hasLabels, DataType[] dataTypes)
	{
	 ...
	 * @return
	 */
	private static ArrayList<Object> getOldExcelFileResults(String fileLocation, String fileName, Boolean hasLabels, DataType[] dataTypes)
	{
		ArrayList<Object> data = null;
		String fullFilePath = fileLocation + fileName;
		InputStream newExcelFormatFile;
